...
```
cd existing_repo
git remote add origin https://gitlab.com/softcreative1/moblie-app/cia-app.git
git branch -M main
...
* [Set up project integrations](https://gitlab.com/softcreative1/moblie-app/cia-app/-/settings/integrations)
...
```
cd existing_repo
git remote add origin https://gitlab.com/softcreative1/moblie-app/ciac-app.git
git branch -M main
git push -uf origin main
```
...
* [Set up project integrations](https://gitlab.com/softcreative1/moblie-app/ciac-app/-/settings/integrations)
