...
/// This code copy from other library https://pub.dev/packages/ai_barcode_scanner/example
class OverlayShape extends ShapeBorder {
  ...
  void paint(Canvas canvas, Rect rect, {TextDirection? textDirection}) {
    ...
    final cutHeight = cutOutHeight < height ? cutOutHeight : height - borderOffset;
